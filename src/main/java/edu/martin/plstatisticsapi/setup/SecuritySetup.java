package edu.martin.plstatisticsapi.setup;
...
import edu.martin.plstatisticsapi.util.Api;
import edu.martin.plstatisticsapi.util.Api.Privileges;
import edu.martin.plstatisticsapi.util.Api.Roles;
import edu.martin.plstatisticsapi.util.Profiles;
...
public class SecuritySetup implements ApplicationListener<ContextRefreshedEvent> {
  ...
  final void createUsers() {
    ...
    createUserIfNotExisting(Api.ADMIN_EMAIL, Api.ADMIN_PASS, Sets.<Role> newHashSet(roleAdmin));
  }
